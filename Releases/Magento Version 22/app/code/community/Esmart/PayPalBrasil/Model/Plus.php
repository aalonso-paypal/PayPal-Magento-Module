...
class Esmart_PayPalBrasil_Model_Plus extends Mage_Payment_Model_Method_Abstract
{
    ...
    public function createShippingAddress($quote = null)
    {
        ...
        $line1 = Mage::getStoreConfig('payment/paypal_plus/address_line_1');
        $line1 = $helper->getDataFromObject($addressShipping, $this->nonPersistedData, $line1);
     ...
     * @return $this
     */
    public function setNonPersistedData(array $postData)
    {
        foreach ($postData as $key => $value) {
            if (is_array($value)) {
                $this->setNonPersistedData($value);
                continue;
            }
